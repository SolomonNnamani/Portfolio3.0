...
const Hero = () => {
  ...
  const links = [
    ...
    //{ icons: <FaLinkedinIn  />, href: "#linkedln" },
    ...
    <section 
      ...
      <div className="flex justify-center">
        ...
        <div className=" fade-in space-y-3 text-center">
          ...
          <p className=" md:text-xl lg:text-2xl md:px-15 lg:px-50">
            ...
            <div className="flex items-center justify-center gap-6 md:gap-8 lg:gap-10">
              {links.map((link, index) => (
                <a
                  key={index}
                  href={link.href}
                  className=" flex items-center text-2xl hover:text-green-500 hover:scale-110 transition lg:text-3xl justify-center transition duration-300"
                >
                  {link.icons}
                </a>
              ))}
